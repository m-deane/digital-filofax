    ...
    <Card className="border-orange-200 dark:border-orange-900">
      <CardHeader className="flex flex-row items-center justify-between pb-2 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-950/20 dark:to-red-950/20">
        <div className="flex items-center gap-2">
          ...
          <div>
            <CardTitle className="text-lg font-semibold">Don&apos;t Forget</CardTitle>
            <CardDescription>{urgentTasks.length} items need your attention</CardDescription>
          </div>
        </div>
        <Link href="/dashboard/tasks">
          <Button variant="ghost" size="sm">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Your planner overview for today
          </p>
        </div>
        <WidgetPicker />
      </div>
